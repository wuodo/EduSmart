...
import { getStaffPerformance, getSlaSummary, getEscalationSummary, getPerformanceTrend, updateInquiryFirstResponse } from '../controllers/accountability.controller';
import { requireAuth } from '../middleware/requireAuth';

const router = express.Router();

router.get('/staff-performance', requireAuth, getStaffPerformance);
router.get('/performance-trend', requireAuth, getPerformanceTrend);
