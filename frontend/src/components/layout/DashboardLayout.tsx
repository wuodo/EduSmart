                    ...
                    {deleteRequests.length === 0 && broadcastUnreadCount === 0 && staffNotifications.length === 0 && unreadChatCount === 0 ? (
                      ...
                      <>
                        ...
                        {staffNotifications.slice(0, 5).map((n: any, i: number) => (
                            <div key={`staff-${i}`} className="px-3 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors" onClick={() => { if (n.link) router.push(n.link); setShowNotifPanel(false); }}>
                            <div className="flex items-start gap-2">
