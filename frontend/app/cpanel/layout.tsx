...
import {
  ...
  BarChart3, Activity, KeyRound, Globe, Siren, ListChecks, Gavel, FileCheck2, LifeBuoy, Cog, Timer, Wrench,   RotateCcw, UserCheck, Mail
} from 'lucide-react';
...
const nav = [
  ...
  { href: '/cpanel/smtp', label: 'SMTP Settings', icon: Mail },
  ...
  return (
    <div className="min-h-screen text-gray-900" style={{ backgroundColor: '#e9ebef' }}>
      <div className="flex min-h-screen">
        <aside className="hidden md:block w-48 bg-teal-800 text-white overflow-y-auto sticky top-0 self-start">
